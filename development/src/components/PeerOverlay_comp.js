        ...
        <div className="bg-white text-[#0E0C46] dark:bg-[#504F5F] p-6">
            <div className=" flex flex-col">
                <div className="flex justify-between">
                    <div className=" font-bold text-3xl leading-8 font-nohemi">New Peer Session</div>
                    <button onClick={handleClose}><Image src={closeIconBlack} className="w-5 h-5" /></button>
                </div>
                <div>
                    <div className="text-base text-[#0E0C46] font-nohemi font-semibold mt-8 leading-5">Session Name</div>
                    <input
                        type="text"
                        name="sessionname"
                        id="sessionname"
                ...
                <div>
                    ...
                    <div className="flex justify-between ">
                        <div
                            ...
                            className={` w-32 h-32 flex justify-center items-center flex-col  shadow-md shadow-black rounded-md ${activeLanguage === 'html'
                                ? 'bg-blue-500 text-white'
                                : '  bg-gray-200 dark:bg-[#3D3D48]'
                                }`}>
                            <Image src={HTML} className="w-8 h-9 mb-4" />
                            <div className="text-[#5F5BD7] font-nohemi font-bold text-xl">HTML</div>
                        </div>
                        <div
                            onClick={() => setActiveLanguage('css')}
                            className={` w-32 h-32 flex justify-center items-center shadow-md shadow-black flex-col rounded-md ${activeLanguage === 'css'
                                ? 'bg-blue-500 text-white '
                                : ' bg-gray-200 dark:bg-[#3D3D48]'
                                }`}>
                            <Image src={CSS} alt="language-icon" className="w-8 h-8 mb-4" />
                            <p className="text-[#5F5BD7] font-nohemi font-bold text-xl">CSS</p>
                        </div>
                        <div
                            onClick={() => setActiveLanguage('javascript')}
                            className={` w-32 h-32 flex justify-center shadow-md shadow-black items-center flex-col rounded-md ${activeLanguage === 'javascript'
                                ? 'bg-blue-500 text-white'
                                : ' bg-gray-200 dark:bg-[#3D3D48]'
                                }`}>
