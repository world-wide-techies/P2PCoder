        ...
        <div className="bg-[#2F2F3A] text-white p-6">
            <div className=" flex flex-col">
                <div className="flex justify-between">
                    ...
                    <button><Image src={closeIconWhite} className="w-5 h-5" /></button>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div className="flex justify-between ">
                        ...
                        <div
                            ...
                            <p className="text-white font-nohemi font-bold text-xl">CSS</p>
                        </div>
                        <div
                            onClick={() => setActiveLanguage('js')}
                            className={` w-32 h-32 flex justify-center shadow-md shadow-black items-center flex-col rounded-md ${activeLanguage === 'js'
                                    ? 'bg-blue-500 text-white'
                                    : ' bg-gray-200 dark:bg-[#3D3D48]'
                                }`}>
                            <Image src={JS} alt="language-icon" className="w-8 h-9 mb-4" />
                            <p className="text-white font-nohemi font-bold text-xl">JS</p>
                        </div>
                    </div>
                </div>
